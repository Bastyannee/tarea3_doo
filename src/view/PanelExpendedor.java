...
public class PanelExpendedor extends JPanel {
    ...
    public void reposicionarElementos() {
       ...
       // DEPÓSITO DE DESPACHO (Rectángulo negro inferior izquierdo)
        Producto pDespacho = exp.peekProducto(); // Usa peek, no get
        if (pDespacho != null) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Dibujar el producto despachado si existe
        Producto pDespacho = exp.peekProducto();
        if (pDespacho != null) {
            pDespacho.paintComponent(g);
        }
    }
